...
type AdminClient interface {
	...
	AddSection(ctx context.Context, in *Section, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *adminClient) AddSection(ctx context.Context, in *Section, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/here.Admin/AddSection", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdminServer interface {
	...
	AddSection(context.Context, *Section) (*emptypb.Empty, error)
...
func (UnimplementedAdminServer) AddSection(context.Context, *Section) (*emptypb.Empty, error) {
...
func _Admin_AddSection_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Section)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServer).AddSection(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/here.Admin/AddSection",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServer).AddSection(ctx, req.(*Section))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Admin_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Admin_AddSection_Handler,
		},
		{
